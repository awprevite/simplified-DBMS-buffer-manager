...
I created this project with IntelliJ. To compile, open the CS4432Project1 and press run.
Alternatively follow these steps in the terminal.

1. Navigate to the project folder directory, CS4432Project1
2. javac -d out src/*.java
3. java -cp out Main

Both these methods will begin the program and prompt you to enter a size for the buffer
